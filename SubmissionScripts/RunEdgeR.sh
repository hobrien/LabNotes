...
# split week 14 sample in half
Rscript ~/BTSync/FetalRNAseq/LabNotes/R/FvsMedgeR.r --min 14 --max 15 -e 17812,18282,18349,18355,18687,16428,16488,16640,16929
Rscript ~/BTSync/FetalRNAseq/LabNotes/R/FvsMedgeR.r --min 14 --max 15 -e 19043,17921,19031,17221,18015,17053,17071,18529,18856
