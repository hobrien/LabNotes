...
junction_annotation.py -r /home/heath/Ref/Homo_sapiens/NCBI/GRCh38Decoy/Annotation/Genes.gencode/genes.bed -i $@ -o $folder_path/$folder  >  $folder_path/$folder.junction.txt
...
mkdir $folder_path/BAM
split_bam.py -r /home/heath/Ref/Homo_sapiens/NCBI/GRCh38Decoy/Sequence/AbundantSequences/humRibosomal.bed -i $@ -o $folder_path/BAM/$folder
...
insertion_profile.py -l 100 -s PE -i $@ -o $folder_path/$folder
