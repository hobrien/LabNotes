...
margin_theme <- function() {
  ...
  theme(axis.title.x=element_text(size=24,color=color.axis.title, vjust=0)) +
  theme(axis.title.y=element_text(size=24,color=color.axis.title, vjust=1.25, margin=margin(0,10,0,0)))
}
