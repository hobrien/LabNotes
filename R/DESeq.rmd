...
DESeq2results <- data.frame(BrainBank=c( "All", 
                            ...
                            n=c(108, 100, 61, 58, 53, 47, 100, 53, 52, 
                                rep(51, 4), 50, rep(46, 2), 48
                                ),
                            test=c(rep("Wald", 6), rep("LRT", 2), rep("Wald", 9)),
                            CooksCutoff=c(rep("None", 10), 2, 1, 0.75,
                                          rep("None", 2), rep(0.75, 2)
                                          ),
...
kable(select(DESeq2results, -results) %>% filter(Excluded == "None" | AgeRange == "14-18"))
```
