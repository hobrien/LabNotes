...
```{r}
CountFolder <- "~/BTSync/FetalRNAseq/Counts/"
DESeq2results <- data.frame(BrainBank=c( "All", 
                            ...
                            RIN=c(rep("All", 19), rep("4", 3), rep("All", 2)),
                            FDR=c(rep(0.05, 20), 0.1, rep(0.05, 3)),
                            Excluded=c(rep("None", 8), 
                                       ...
                                       rep("15641/18432", 3),
                                       rep("19 samples", 3),
                                       rep("15641/18432/16491", 2)
                                       ),
                            n=c(108, 100, 61, 58, 53, 47, 100, 53, 52, 
                                rep(51, 4), 50, rep(46, 2), 48, 50, 47, 
                                rep(34, 3), rep(97, 2)
                                ),
                            test=c(rep("Wald", 6), 
                                   rep("LRT", 2), 
                            ...
                            CooksCutoff=c(rep("None", 10), 2, 1, 0.75,
                                          rep("None", 2), rep(0.75, 6),
                                          rep("None", 3)
                                          ),
                            DEgenes=c(68, 88, 633, 1747, 2665, 47, 154, 868,
                                      2305, 2961, 1738, 1763, 1756, 1170, 46, 
                                      48, 105, 63, 286, 71, 140, 48, 312, 8009
                                      ),
                            results=c(paste0(CountFolder, "MvsF_all2"),
                                      paste0(CountFolder, "MvsF_12_20_noA"),
                                      paste0(CountFolder, "MvsF_old"),
                                      paste0(CountFolder, "MvsF_14_20A"),
                                      paste0(CountFolder, "MvsF_14_20_noA"),
                                      paste0(CountFolder, "MvsF_12_14_noA"),
                                      paste0(CountFolder, "MvsF_LRT_12_20_noA"),
                                      paste0(CountFolder, "MvsF_LRT_14_20_noA"),
                                      paste0(CountFolder,
                                             "MvsF_14_20_noA_excl_15641"
                                             ),
                                      paste0(CountFolder, 
                                            "MvsF_14_20_noA_excl_15641_18432"
                                            ),
                                      paste0(CountFolder, 
                                      "MvsF_14_20_noA_excl_15641_18432_Cooks2"
                                            ),
                                      paste0(CountFolder, 
                                      "MvsF_14_20_noA_excl_15641_18432_Cooks1"
                                            ),
                                      paste0(CountFolder, 
                                      "MvsF_14_20_noA_excl_15641_18432_Cooks.75"
                                            ),
                                      paste0(CountFolder, 
                                      "MvsF_14_20_noA_excl_15641_18432_16428"
                                            ),
                                      paste0(CountFolder, 
                                            "MvsF_14_20_noA_excl_16491"
                                            ),
                                      paste0(CountFolder, 
                                            "MvsF_14_20_noA_excl_16491_Cooks.75"
                                            ),
                                      paste0(CountFolder, 
                                      "MvsF_14_20_noA_excl_15641_18432_Cooks.75"
                                            ),
                                      paste0(CountFolder, 
                                      "MvsF_14_20_excl_15641_18432_Cooks.75"
                                            ),
                                      paste0(CountFolder,
                                             paste("MvsF", "14", "17.75", 
                                                   "noA", "excl", "15641",
                                      ...
                                      paste0(CountFolder,
                                             "MvsF_12_20_noA_lrt_age"
                                            )
                                      )
                            )
kable(select(DESeq2results, -results) %>% filter(Excluded == "None" | AgeRange == "14-18" | AgeRange == "14-17.75" | AgeRange == "14-17.15" | AgeRange == "12-20"))
```
...
All_Samples <- read.delim("~/BTSync/FetalRNAseq/Counts/MvsF_12_20_noA_lrt_age/tables/dropPCW.complete.txt", stringsAsFactors = FALSE)

LateSamples <- read.delim("~/BTSync/FetalRNAseq/Counts/MvsF_14_20_noA_excl_15641_18432_Cooks.75/tables/MalevsFemale.complete.txt", stringsAsFactors = FALSE)

EarlySamples <- read.delim("~/BTSync/FetalRNAseq/Counts/MvsF_12_14_noA_excl_16491_Cooks.75/tables/MalevsFemale.complete.txt", stringsAsFactors = FALSE)
```
...
```{r}
kable(select(DESeq2results, -results) %>% 
        filter(BrainBank ==  "HDBR only" & AgeRange == "12-14" & test == 'Wald')
      )
```
