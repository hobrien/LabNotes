...
Female_up_14_20_Deseq <- read_delim("~/BTSync/FetalRNAseq/Counts/MvsF_14_20_noA_Cooks.75_excl_15641_18432_FDR.1_new/tables/FemaleUp.txt", 
     "\t", escape_double = FALSE, trim_ws = TRUE)
par(mfrow=c(1,2))
venn(list(DESeq=Male_up_14_20_Deseq$Id, edgeR=Male_up_14_20_EdgeR$Id))
title(main="Male Up FDR<0.1")
venn(list(DESeq=Female_up_14_20_Deseq$Id, edgeR=Female_up_14_20_EdgeR$Id))
...
write_delim(Female_up_intersection, "~/BTSync/FetalRNAseq/Counts/MvsF_14_20_female_up_intersection.txt")
...
write_delim(Male_up_intersection, "~/BTSync/FetalRNAseq/Counts/MvsF_14_20_male_up_intersection.txt")
...
Female_up_14_20_FDR.05_Deseq <- read_delim("~/BTSync/FetalRNAseq/Counts/MvsF_14_20_noA_Cooks.75_excl_15641_18432_new/tables/FemaleUp.txt", 
     "\t", escape_double = FALSE, trim_ws = TRUE)
par(mfrow=c(1,2))
venn(list(DESeq=Male_up_14_20_FDR.05_Deseq$Id, edgeR=Male_up_14_20_FDR.05_EdgeR$Id))
title(main="Male Up FDR<0.05")
venn(list(DESeq=Female_up_14_20_FDR.05_Deseq$Id, edgeR=Female_up_14_20_FDR.05_EdgeR$Id))
