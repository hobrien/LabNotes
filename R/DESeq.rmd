...
`r margin_note("- For some reason, when I reran the 12-20 week anaysis, the number of DE genes dropped from 105 to 88 (ole results  are in MvsF_12_20_noA_bk)")`
...
DESeq2results <- data.frame(BrainBank=c( "All", 
                            ...
                            n=c(108, 100, 61, 58, 53, 47, 100, 53, 52, 
                                rep(51, 4), 50, rep(46, 2)
                                ),
                            test=c(rep("Wald", 6), rep("LRT", 2), rep("Wald", 8)),
                            CooksCutoff=c(rep("None", 10), 2, 1, 0.75, rep("None", 2), 0.75),
                            DEgenes=c(68, 88, 633, 1747, 2665, 47, 154, 868,
                                      2305, 2961, 1738, 1763, 1756, 1170, 46, 48
                                      ),
                            results=c(paste0(CountFolder, "Counts/MvsF_all2"),
                                      paste0(CountFolder, "Counts/MvsF_12_20_noA"),
                                      paste0(CountFolder, "Counts/MvsF_old"),
                                      paste0(CountFolder, "Counts/MvsF_14_20A"),
                                      paste0(CountFolder, "ounts/MvsF_14_20_noA"),
                                      paste0(CountFolder, "Counts/MvsF_12_14_noA"),
                                      paste0(CountFolder, "MvsF_LRT_12_20_noA"),
                                      paste0(CountFolder, "MvsF_LRT_14_20_noA"),
                                      paste0(CountFolder, "MvsF_14_20_noA_excl_15641"),
                                      paste0(CountFolder, 
...
NoteSig <- function(gene_id, gene_name, EarlySamples, LateSamples) {
...
for (gene_name in c('PAX6', 'SOX2', 'EOMES')) {
  ...
  pvalues <- bind_rows(pvalues, NoteSig(gene_id, gene_name, EarlySamples, LateSamples))
}
kable(pvalues)
```
