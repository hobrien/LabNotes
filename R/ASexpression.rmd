...
```{r }
count_file <- "~/BTSync/FetalRNAseq/Counts/Dedup/chr10:102901727-102901727.counts.txt"
...
```{r }
count_file <- "~/BTSync/FetalRNAseq/Counts/Dedup/chr1:98046571-98046571.counts.txt"
...
```{r }
counts <- read_tsv("~/BTSync/FetalRNAseq/Counts/Dedup/chr2:192775750-192775750.counts.txt", col_names=c('chr', 'pos', 'ref_base', 'ref', 'alt', 'sample'))
...
```{r }
count_file <- "~/BTSync/FetalRNAseq/Counts/chr6:30186422-30186422.counts.txt"
...
## deduplicated
```{r }
counts <- read_tsv("~/BTSync/FetalRNAseq/Counts/Dedup/chr6:30186422-30186422.counts.txt", col_names=c('chr', 'pos', 'ref_base', 'ref', 'alt', 'sample'))
counts <- left_join(counts, riskVar[,c(3,4)]) %>% left_join(ExpressedSNP[,c(3,4)])
...
```{r }
count_file <- "~/BTSync/FetalRNAseq/Counts/chr8:2937908-2937908.counts.txt"
...
## deduplicated
```{r }
count_file <- "~/BTSync/FetalRNAseq/Counts/Dedup/chr8:2937908-2937908.counts.txt"
counts<-GetCounts(count_file, riskVar_file, ExpressedSNP_file)
...
```{r }
count_file <- "~/BTSync/FetalRNAseq/Counts/Dedup/chr8:88039069-88039069.counts.txt"
...
```{r }
count_file <- "~/BTSync/FetalRNAseq/Counts/chr10:103089711-103089711.counts.txt"
