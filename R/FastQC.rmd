...
lengths <- filter(lengths, !grepl("_R2_",V1))
...
lengths <- full_join(LibraryInfo, SeqInfo, by=c("sample" = "V2")) %>% View()
  right_join(lengths)
lengths<-mutate(lengths, Billion_bp = ifelse(Centre == 'Exeter', 
                                    Million_reads * 200 / 1000, 
                                    ifelse(Centre == 'Edinburgh', 
                                           Million_reads * 250 / 1000, 
                                           Million_reads * 150 / 1000
                                           )
                                    )
       )
