...
write.table(x, file = "/c8000xd3/rnaseq-heath/Counts/DEXSeq/results.txt")
...
plotMA( dxr1, cex=0.8 )
dev.off()
DEXSeqHTML( dxr1, FDR=0.1, color=c("#FF000080", "#0000FF80"), fitExpToVar="Sex", path="/c8000xd3/rnaseq-heath/Counts/DEXSeq", BPPARAM=BPPARAM )